...
const plan = [
    {
        siteName: "Site name",
        name: "Mary Cristi Hydraulic Technology",
        description: 
        "Mary Cristina Vallejos is a mission friend from perú and she have a company related to Hydraulic irrigation systems. I want to help her and give a gift with his web site.",
        category: "blog"
    },

    {
        ...
        description: 
        "Sales of Supplies and Installation of Irrigation Systems, Technified by Drip, Sprinkler, and Micro Sprinkler, Gardening, Project Development, Design, and Technical Consulting.",
        category: "blog"
    },

    {
        siteName: "Scenarios",
        scenarioOne: "How farmers can find the appropriate drip tapes for their planting projects.",
        scenarioTwo: "Find a gallery of different irrigation systems for farms.",
        category: "specials"
    },
    ...
    {
        siteName: "Typography",
        name: "Gravitas One, Libertinus Sans and Sans serif",
        description: "Body: Libertinus, Sans serif",
